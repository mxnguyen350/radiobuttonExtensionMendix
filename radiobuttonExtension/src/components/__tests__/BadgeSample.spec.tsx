...
import { BadgeSample, BadgeSampleProps } from "../RadioButtonExtension";
...
describe("Badge", () => {
    ...
    it("should render the structure", () => {
        ...
        expect(badge.equals(<span className="widget-radiobuttonextension badge label-default">0</span>)).toEqual(true);
    });
